...
- Do not derive temporary-enchantment display names through tooltip scraping, private provider inspection, AuraButton enumeration, or hardcoded enchant-ID maps. Use only supported public slot/enchant metadata and native weapon-tooltip context; the public Retail contract does not currently provide a clean temporary-enchant effect name.
