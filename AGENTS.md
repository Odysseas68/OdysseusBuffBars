...
- Current phase: retain managed-only production plus rollback while hardening managed capability/readiness and partial-initialization containment before any authority retirement. Legacy scanner/bar/secure-overlay retirement and the `ManagedPrototype` production rename remain separate reviewable work.
