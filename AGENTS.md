...
- The next separate cleanup task is the diagnostic retention/removal audit. Any future frame-name migration decision remains deferred unless a concrete need appears.
