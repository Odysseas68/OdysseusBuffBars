...
- Later cleanup — The next clean architectural task is managed production naming/terminology; Config polish, media/library work, licensing, OdysseusDebugConsole, and release preparation remain separate later work
