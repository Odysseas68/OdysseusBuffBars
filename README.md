...
- Backend cleanup — Fishing Lure formatter extraction and the Bars/secure-overlay and Auras/Engine retirements are complete; next perform the read-only Core bootstrap / Config compatibility fallback audit
