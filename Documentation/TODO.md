...
- [ ] Task 8: create and push the annotated `v1.0.0` tag.
- [ ] Task 9: create the curated installable ZIP and GitHub Release.
- [ ] Task 10: perform post-release verification.
