...
- Kept arbitrary graph/cycle parity, BUFFS-as-child, future full ENCHANTMENTS bounds, ABOVE cutover handling, final parity audit, opportunistic direct OffHand/both-slot coverage, broader native lifecycle coverage, production cutover, rollback policy, release preparation, and eventual comparison/legacy cleanup pending.
